...
INSERT INTO ABSENCE (ID,START,END,STATUS,REASON,EMPLOYEE_ID) VALUES (1,{ts '2015-01-01'},{ts '2015-01-10'},'CONFIRMED','COLD_FLU',4);
INSERT INTO ABSENCE (ID,START,END,STATUS,REASON,EMPLOYEE_ID) VALUES (2,{ts '2015-02-01'},{ts '2015-02-05'},'CONFIRMED','COLD_FLU',4);
INSERT INTO ABSENCE (ID,START,END,STATUS,REASON,EMPLOYEE_ID) VALUES (3,{ts '2015-03-01'},{ts '2015-03-15'},'CONFIRMED','STRESS_DEPRESSION',4);
INSERT INTO ABSENCE (ID,START,END,STATUS,REASON,EMPLOYEE_ID) VALUES (4,{ts '2015-04-01'},{ts '2015-06-01'},'CONFIRMED','MATERNITY',4);
INSERT INTO ABSENCE (ID,START,END,STATUS,REASON,EMPLOYEE_ID) VALUES (5,{ts '2015-05-01'},{ts '2015-05-04'},'CONFIRMED','CARERS',4);

INSERT INTO ABSENCE (ID,START,END,STATUS,REASON,EMPLOYEE_ID) VALUES (6,{ts '2015-01-01'},{ts '2015-01-03'},'CONFIRMED','COLD_FLU',3);
INSERT INTO ABSENCE (ID,START,END,STATUS,REASON,EMPLOYEE_ID) VALUES (7,{ts '2015-06-01'},{ts '2015-05-10'},'CONFIRMED','BACK_PROBLEMS',3);
INSERT INTO ABSENCE (ID,START,END,STATUS,REASON,EMPLOYEE_ID) VALUES (8,{ts '2015-07-01'},{ts '2015-07-13'},'CONFIRMED','BEREAVEMENT',3);